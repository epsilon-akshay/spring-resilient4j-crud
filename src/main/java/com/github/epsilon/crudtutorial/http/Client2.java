...
public class Client2 {
    ...
    @Autowired
    public Client2(RestTemplate restTemplate, int id) {
        this.restTemplate = restTemplate;
        this.id = id;
    }

    public <T> T get(String url) throws URISyntaxException {
        System.out.println("incoming request for client 2");
        String va = String.format("https://localhost:9090/external-foo/%d", id);
    ...
    @CircuitBreaker(name = "client2", fallbackMethod = "fallback")
